      ...
      <Navbar bg="white" variant="dark">
        <Container>
          <Nav className="navCategory">
            <h5 onClick={() => setCategory("sport")} className="marginMenu1">
              Sport
            </h5>
            <h5 onClick={() => setCategory("business")} className="marginMenu">
              Business
            </h5>
            <h5
            ...
            <h5 onClick={() => setCategory("general")} className="marginMenu">
              General
            </h5>
            <h5 onClick={() => setCategory("health")} className="marginMenu">
              Health
            </h5>
            <h5 onClick={() => setCategory("science")} className="marginMenu">
              Science
            </h5>
            <h5
